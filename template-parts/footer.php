            ...
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="https://wa.me/<?php echo esc_attr($whatsapp); ?>" target="_blank" rel="noopener" class="text-gray-400 hover:text-[#d4af37] transition-colors" aria-label="WhatsApp">
                            <svg style="width: 24px; height: 24px;" viewBox="0 0 24 24" fill="currentColor">
...
<div class="floating-contact-wrapper">
    ...
    <div id="floatingContactItems" class="floating-contact-items">
        ...
        <div class="floating-contact-item" data-delay="0.2">
            ...
            <a href="https://wa.me/<?php echo esc_attr($whatsapp); ?>?text=Hello,Nusa Penida Tattoo%20I%20want%20to%20book%20a%20tattoo%20session" 
